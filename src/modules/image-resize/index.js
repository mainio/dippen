...
import DisplaySize from './modules/display-size.js'
 ...
 *
 * License: MIT
 * Authors: @mudoo, @kensnyder (original version for Quill v1)
 */
export default class QuillResize {
  ...
  handleClick(evt) {
    ...
    // If it is a root element, it means that the embed element event may be
    // penetrated, and you need to get the element based on the cursor position
